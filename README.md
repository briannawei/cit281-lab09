...
Assignment based off of Github's [Create a release based workflow](https://lab.github.com/githubtraining/create-a-release-based-workflow)
(Attached code is one out of the eight parts of the course)
```
(function() {
    var lastTime = 0;
